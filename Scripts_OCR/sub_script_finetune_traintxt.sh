...
echo "KETOS training"
srun ketos train -t split/train.txt -e split/val.txt -f alto -i Gallicorpora+_best.mlmodel --resize add -d cuda:0 -r 0.0001 --lag 10 --workers 8 --normalization NFD
